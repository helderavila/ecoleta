...
const CreatePoint = () => {
  ...
  const handleSelectedUf = (event: ChangeEvent<HTMLSelectElement>) => setSelectedUf(event.target.value)

  const handleSelectedCity = (event: ChangeEvent<HTMLSelectElement>) => setSelectedCity(event.target.value)
